    ...
    public void populate() throws Exception {
        ...
        List<Product> products = Arrays.asList(
                ...
                new Product("Best. Cloud. Ever. (T-Shirt, Men's Large)", "SKU-24642", "<p>Do you love your cloud platform? " +
                        ...
                        "Four nines of <em>stylability</em></p>", 23.99),
                ...
                new Product("Like a BOSH (T-Shirt, Women's Medium)", "SKU-34563", "<p>The BOSH Outer Shell (<strong>BOSH</strong>) " +
                        ...
                        "The feeling of spinning up a highly available distributed system is second only to the " +
                ...
                new Product("We're gonna need a faster container (T-Shirt, Women's Small)", "SKU-12464", "<i>\"Mr. Vaughn, what we are dealing with here is " +
                ...
                new Product("Cyclone push awesome (Hoodie, Men's Medium)", "SKU-64233",
